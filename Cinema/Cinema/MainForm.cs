...
namespace Cinema
{
    public partial class MainForm : Form
    {
        ...
        {
            System.Diagnostics.Process.Start("https://www.youtube.com/watch?v=lK7Wd0pA5a4"); 
        }
        ...
        {
            System.Diagnostics.Process.Start("https://www.youtube.com/watch?v=1d2ocjGs-Nk");
        }
        ...
        {
            pictureBox2.Location = new Point(319, 80);
        }

        private void pictureBox2_MouseLeave(object sender, EventArgs e)
        {
            pictureBox2.Location = new Point(319, 100);
        }
